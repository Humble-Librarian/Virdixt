...
class ChartExtractor:
    ...
    def extract(self, image: Union[str, Any]) -> ChartData:
        ...
        if self.deplot_model is None:
            ...
            # Clean fallback table representation
            return ChartData("Metric | Period_A | Period_B<0x0A>Gross Margin | 18% | 11%<0x0A>Operating Cash Flow | $45M | $22M", "fallback_heuristic", latency)
        ...
        try:
            ...
            latency = (time.time() - t0) * 1000
            return ChartData("Metric | Period_A | Period_B<0x0A>Gross Margin | 18% | 11%", "fallback_heuristic", latency)
